...
**環境に固有の可能性がある。** 第 4.1 節の NaN は M1 / PyTorch 2.2.2 / MPS / fp16 で観測した。加算元の中身と出力への伝播までは測ったが、最初の NaN がそのバッファに入る経路と、他の PyTorch 版やハードウェアでの再現は扱っていない。推奨設定に従うと例外を出さずに壊れる構図そのものは、環境が違っても起こりうる。
